...
var KoalaTokenSale = artifacts.require("./KoalaTokenSale.sol");

contract("KoalaTokenSale", function (accounts) {
  var tokenInstance;
  var tokenSaleInstance;
  var admin = accounts[0];
  var buyer = accounts[1];
  var tokenPrice = 10000000000; // in wei
  var tokensAvailable = 750000;
  var numberOfTokens;

  it("initializes the contract with the correct values", function () {
    return KoalaTokenSale.deployed()
  ...
  it("ends token sale", function () {
    return KoalaToken.deployed()
      ...
      .catch(function (error) {
        assert(
          error.message.indexOf("revert" >= 0, "must be admin to end the sale")
        );
