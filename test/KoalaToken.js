...
//         // the reason we use it is we don't want to write to the blockchain
//         // we only want to inspect the whether the function call fails
...
//         // Transfer some tokens from the contract creator to fromAccount
//         return tokenInstance.transfer(fromAccount, 100, { from: accounts[0] });
//       })
//       .then(function (receipt) {
//         // Approve spendingAccount to spend 10 tokens on fromAccount's behalf
